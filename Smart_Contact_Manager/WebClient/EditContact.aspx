<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditContact.aspx.cs" Inherits="WebClient.EditContact" MasterPageFile="~/Site.Master" %>
                    ...
                    <div class="card-body">
                        <div class="auto-form-wrapper">
                            <form runat="server">
                                ...
                                <div class="form-group">
                                    <asp:Button ID="SubmitButton" CssClass="btn btn-primary submit-btn btn-block" Text="Update" runat="server" OnClick="SubmitButton_Click"></asp:Button>
                                </div>
                            </form>
                        </div>
